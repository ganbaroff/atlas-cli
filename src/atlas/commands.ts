...
export const COMMANDS: readonly AtlasCommand[] = [
  ...
  { cmd: 'brief', ru: 'шеф-офицерский борд: шесть категорий, что требует решения', en: 'chief-of-staff board: six categories, what needs a decision' },
  { cmd: 'drift', ru: 'сигналы дрейфа: unpushed commits, стухший heartbeat, stuck tasks', en: 'drift signals: unpushed commits, stale heartbeat, stuck tasks' },
  { cmd: 'tasks', ru: 'активные задачи из exec-graph (не закрытые/не верифицированные)', en: 'active exec-graph tasks (not closed/verified)' },
