...
| A | Phase 1 gemini+azure providers · Phase 5A-iii recall write-back | Sonnet `claude -p` | PENDING | — | — |
| B | Phase 2.8 LLM-first emotion read + wire emotion.ts into telegram reply path | Sonnet `claude -p` | PENDING | — | — |
